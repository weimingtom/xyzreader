...
public class ArticleDetailActivity extends AppCompatActivity
        implements LoaderManager.LoaderCallbacks<Cursor>,  Transition.TransitionListener {
...
//                getResources().getDimensionPixelSize(R.dimen.initialTextScroll);
//        ScrollView scrollView = (ScrollView)findViewById(R.id.ns_view);
...
//    }
    ...
    private void animateTextViews(){
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.text_views);
//        Animation hyperspaceJumpAnimation = AnimationUtils.loadAnimation(this, R.anim.scroll_down);
//        //linearLayout.startAnimation(hyperspaceJumpAnimation);
//        linearLayout.setAnimation(hyperspaceJumpAnimation);
//        hyperspaceJumpAnimation.setStartTime(1000L);
        ...
        Animation slideInAnimation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,0.0f,
                ...
                Animation.RELATIVE_TO_PARENT, 0.0f);
        slideInAnimation.setDuration(1000L);
